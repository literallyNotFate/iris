...
mod tests {
    ...
    #[test]
    fn should_revert_changes_on_failure_for_rollback_guard() {
        ...
        {
            let _guard = RollbackGuard::new(target.clone(), backup.clone());
    ...
    #[test]
    fn should_handle_delete_if_not_existed_for_rollback_guard() {
        let temp_dir: TempDir = TempDir::new("rollback_test").unwrap();
